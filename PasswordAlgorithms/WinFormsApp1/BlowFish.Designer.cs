namespace WinFormsApp1
{
	partial class BlowFish
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Size = new System.Drawing.Size(392, 78);
			this.label1.TabIndex = 10;
			this.label1.Text = "BlowFish Page";
			// 
			// button3
			// 
			...
			this.lbl2.Location = new System.Drawing.Point(25, 331);
			this.lbl2.Name = "lbl2";
			...
			this.lbl1.Location = new System.Drawing.Point(26, 202);
			this.lbl1.Name = "lbl1";
			...
			this.Name = "BlowFish";
			this.Text = "BlowFish";
			this.Load += new System.EventHandler(this.BlowFish_Load);
